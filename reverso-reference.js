...
window.RR = (function () {
  ...
  const ARCHIVE = [
    ...
    { cat:'unique', slot:'a-big-dipper', year:'2000', name:'The “Big Dipper” Reverso', ref:'272\u2019854',
      craft:'Double dial, 24-hour display, custom starburst dial', owner:'Unknown',
      text:'A steel Reverso built around a double dial with a 24-hour display, its specially made blue starburst dial mapping the stars of the Big Dipper (Ursa Major) across the face rather than showing a conventional astronomical complication. Case No. 2\u2019190\u2019694, dated by Christie\u2019s to circa 2000. The kind of one-off constellation dial that turns a Reverso into something closer to a wearable star chart than a watch.',
      src:'Christie\u2019s cataloguing, ref. 272\u2019854' },

    { cat:'unique', slot:'a-coatofarms-1980s', year:'1980s', name:'The “Reverso II” Enamel Coat of Arms', ref:'1410031 / 1560663',
      craft:'Enamel coat of arms', owner:'No. 185413',
      text:'An 18k yellow gold reversible wristwatch with an enamelled coat of arms on the case-back, fitted with an 18k yellow gold deployant clasp signed by Cartier rather than Jaeger-LeCoultre \u2014 a detail auction cataloguing leaves unexplained, though rival maisons occasionally supplied straps, clasps or cases for one another\u2019s watches earlier in the 20th century, particularly when sold through shared retail or family connections.',
      src:'Antiquorum cataloguing, No. 185413' },

    { cat:'unique', slot:'a-coatofarms-1950s', year:'1950s', name:'The Steel Enamelled Coat of Arms Reverso', ref:'\u2014',
      craft:'Enamel coat of arms', owner:'Movement No. 17644',
      text:'A steel Reverso with an enamelled coat of arms on the case-back, movement No. 17644, case No. 11215 \u2014 continuing, two decades on, the same personalisation tradition that produced the 1930s coat-of-arms Reversos elsewhere in this archive, this time on a steel rather than precious-metal case.',
      src:'Antiquorum cataloguing, movement no. 17644' },

    { cat:'unique', slot:'a-coatofarms-1930s-onyx', year:'1930s', name:'The Onyx Bracelet Coat of Arms Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms \u00b7 extensible steel bracelet with onyx plates', owner:'Unknown',
      text:'A steel gentleman\u2019s Reverso whose case-back carries a red and yellow polychrome enamel coat of arms set against a black ground \u2014 paired with an extensible steel bracelet decorated with black onyx plates, an unusually decorative bracelet treatment for a 1930s sports watch. Coat-of-arms Reversos from this decade are typically documented with plain leather straps; the onyx-plated bracelet here is a genuine rarity within that group.',
      src:'Antiquorum cataloguing, 1930s' },

    { cat:'unique', slot:'a-coa-wienercercle', year:'1930s', name:'The “Wiener Cercle” Reverso', ref:'\u2014',
      craft:'Polychrome enamel medallion', owner:'A Vienna gentlemen\u2019s club',
      text:'A yellow gold Reverso whose case-back carries an oval medallion reading \u201cWIENER CERCLE\u201d around a standing knight in armour bearing a flag \u2014 almost certainly the badge of a Vienna gentlemen\u2019s club or circle (\u201ccercle\u201d being French for \u201ccircle\u201d or club) active in the interwar period. One of a set of nine 1930s Reversos photographed together and published on page 78 of a Jaeger-LeCoultre heritage volume, in a chapter titled \u201cIn Praise of Craftsmanship,\u201d captioned: \u201cA fine collection of Reversos decorated with intricate, coloured coats of arms. All these examples date from the thirties.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-redgriffin', year:'1930s', name:'The “Sans Peur” Griffin Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Possibly Clan Sutherland, Scotland \u2014 not confirmed',
      text:'A steel Reverso whose case-back carries a red winged lion or griffin rampant on a pentagonal shield beneath a coronet, with a scrolled banner beneath reading \u201cSANS PEUR\u201d \u2014 French for \u201cwithout fear.\u201d That motto is best known as the war cry and clan motto of Clan Sutherland in Scotland, though the Sutherland crest badge is traditionally a wildcat rather than a griffin, so the match isn\u2019t certain; \u201cSans Peur\u201d has also been used as a motto by other families and regiments over the centuries. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-runninghorse', year:'1930s', name:'The “HMS Victory” Reverso', ref:'\u2014',
      craft:'Polychrome enamel badge', owner:'Royal Navy \u2014 HMS Victory',
      text:'A steel Reverso decorated with a Royal Navy badge: a running horse on a red oval, ringed with the lettering \u201cO\u00b7H\u00b7M\u00b7S\u201d (On His Majesty\u2019s Service) above and \u201cVICTORY\u201d below, a royal crown at the top and a laurel wreath beneath framing the initials \u201cR\u00b7N.\u201d The wording all but confirms a direct connection to HMS Victory, Nelson\u2019s Trafalgar flagship, permanently berthed at Portsmouth and also the name used for the Royal Navy\u2019s Portsmouth shore establishment through the twentieth century \u2014 making this one of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume that is, unusually, tied to a specific, identifiable institution rather than an unattributed family or club.',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-crownedcross', year:'1930s', name:'The House of Savoy Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Kingdom of Italy \u2014 House of Savoy',
      text:'A steel Reverso whose case-back carries a red shield bearing a white cross beneath a royal crown \u2014 the basic arms of the House of Savoy, adopted as the state arms of the Kingdom of Italy itself from unification in 1861 until the monarchy\u2019s abolition in 1946. The shield sits inside a circular black-and-gold border carrying a repeating decorative or pseudo-lettered motif, in a style consistent with the collar of an Italian royal order (the Order of the Crown of Italy and the Military and Civil Orders of Savoy all used a red-and-white Savoy cross at their centre); which specific order, if any, isn\u2019t confirmed from the photograph alone. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-yellowshield', year:'1930s', name:'The A.S. Roma Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Associazione Sportiva Roma \u2014 now in the Jaeger-LeCoultre museum',
      text:'A steel Reverso carrying the historic crest of A.S. Roma, the Italian football club founded in 1927: the Capitoline Wolf suckling Romulus and Remus on a yellow field in the shield\u2019s upper half, and the intertwined gold monogram \u201cASR\u201d (Associazione Sportiva Roma) on red in the lower half. This is specifically the illustrated 1934 version of the crest, the same shield-and-wolf design the club reintroduced in 1997 and again in 2025\u2019s \u201cprogressive return\u201d to its historic badge \u2014 making this one of the more confidently identifiable pieces in the group of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d A separate page of the same volume, showing this watch again on a tan leather strap, confirms it is now part of Jaeger-LeCoultre\u2019s own museum collection.',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78 and facing page; club crest history confirmed via multiple club and press sources' },

    { cat:'unique', slot:'a-coa-quarteredroundels', year:'1930s', name:'The Crescent and Mullets Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Unidentified',
      text:'A steel Reverso whose case-back carries a crowned shield: a red band across the top bearing a crescent moon flanked by two mullets (heraldic stars), above a shield quartered diagonally in white and black, a small gold shield at its centre and a red lion in the lower field, with a scrolled ribbon beneath. Crescents and mullets together are a recurring device across a number of British family arms, but nothing in the source identifies which family or institution this specific combination belongs to. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-lionsandbells', year:'1930s', name:'The “Nec Timide Nec Tarde” Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Unidentified',
      text:'A steel Reverso with a quartered shield alternating navy fields charged with gold rampant lions and red fields each charged with three silver bells, above a scrolled motto banner reading \u201cNEC TIMIDE NEC TARDE\u201d \u2014 roughly, \u201cneither timidly nor slowly.\u201d It closely echoes the better-documented Latin motto \u201cNec temere, nec timide\u201d (\u201cneither rashly nor timidly\u201d), used historically by the town of Oswestry, the city of Gda\u0144sk, and several British armigerous families including Bailey and Forbes \u2014 though none of those known arms match this specific lion-and-bell quartering, so the exact institution behind this version remains unconfirmed. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-diagonalcrown', year:'1930s', name:'The “Fideliter” Herons Reverso', ref:'\u2014',
      craft:'Polychrome enamel coat of arms', owner:'Unidentified',
      text:'A steel Reverso with a shield divided into black-and-white lozenge-patterned quarters, three white herons or egrets standing in the upper and lower fields and three red roundels each centred with a white cinquefoil (five-petalled flower) across the middle band, above a scrolled banner reading \u201cFIDELITER\u201d \u2014 Latin for \u201cfaithfully.\u201d \u201cFideliter\u201d is a common heraldic motto used by numerous unrelated families and institutions, and herons are frequently used as canting (punning) charges for surnames like Heron or Herne, but nothing in the source narrows this to a specific one. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-coa-mjmonogram', year:'1930s', name:'The “MJ” Monogram Reverso', ref:'\u2014',
      craft:'Engraved monogram, no colour', owner:'Initials “MJ”',
      text:'A steel Reverso engraved simply with the interlocked initials \u201cMJ\u201d inside a hexagonal outline \u2014 no enamel, no colour, no heraldry. Included in the same photographed group as the eight coat-of-arms Reversos elsewhere in this archive specifically as a contrast: the accompanying book text discusses both monograms and coats of arms as period decoration techniques, and this piece represents the plainer of the two. One of nine 1930s Reversos published together on page 78 of a Jaeger-LeCoultre heritage volume, \u201cIn Praise of Craftsmanship,\u201d which quotes an unnamed technical textbook\u2019s rule for engraving of any kind: \u201cbut above all, it must be beautiful.\u201d',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship,\u201d p.78' },

    { cat:'unique', slot:'a-aeroclub-basel', year:'1933', name:'The “Aéroclub Suisse de Bâle” Reverso', ref:'\u2014',
      craft:'Engraved emblem and lettering', owner:'Presented to pilot Alphonse Kammacher',
      text:'A steel Reverso engraved with a winged \u201cACS\u201d emblem and the word \u201cBASEL\u201d beneath \u2014 a gift from the A\u00e9roclub Suisse de B\u00e2le (the Swiss Aero Club\u2019s Basel chapter) to its \u201cmeritorious pilot,\u201d Alphonse Kammacher, in 1933. Per the same Jaeger-LeCoultre heritage volume that documents it, the watch also carried the inscription \u201cMit Dank f\u00fcr die Siege\u201d (\u201cWith thanks for the victories\u201d), and its presentation was accompanied by the battle cry \u201cOn a gagn\u00e9\u201d (\u201cWe won\u201d) \u2014 a piece of triumphalism the book notes \u201craised some eyebrows\u201d given the tense European political climate of the early 1930s. Remarkably, the book reports that Sirio Vernati, a member of that same winning team, still wore the watch decades later, at the time of the book\u2019s writing.',
      src:'Jaeger-LeCoultre heritage publication, \u201cIn Praise of Craftsmanship\u201d (facing page 78)' },

    { cat:'unique', slot:'a-heidelberg-vineyard', year:'\u2014', name:'The Heidelberg Vineyard Reverso', ref:'\u2014',
      craft:'Engraved coat of arms, matched to a physical object', owner:'A vineyard owner near Heidelberg, Germany',
      text:'A yellow gold Reverso, on a brown leather strap, engraved with an ornate armorial figure \u2014 a robed, staff-bearing figure set within scrollwork and grape-vine motifs. Per Jaeger-LeCoultre\u2019s own heritage volume, the owner, who ran a small vineyard near Heidelberg, had the engraving copied directly from the artistic heraldic decoration already carved into the iron door of an old oak wine barrel that was \u201cthe pride of his cellar\u201d \u2014 a barrel bearing the maker\u2019s name \u201cSeeger,\u201d a date reading \u201c1855 \u2026 1955\u201d and \u201c500 Jahr,\u201d and a German rhyming inscription roughly translating to \u201cdrinking makes you cheerful, so drink wine with God, and you will be cheerful and blessed your whole life long.\u201d The book frames this as a demonstration of the Reverso\u2019s flexibility as a canvas: rather than a family coat of arms or a club badge, this owner chose to reproduce the specific decorative emblem of an object he prized in his own life.',
      src:'Jaeger-LeCoultre heritage publication (chapter on personalisation, facing the \u201cHeraldry for Beginners\u201d chapter)' },

    { cat:'unique', slot:'a-scherb-basel', year:'\u2014', name:'The Scherb Family Reverso', ref:'\u2014',
      craft:'Engraved private coat of arms', owner:'The Scherb family, Basel',
      text:'A two-tone gold Reverso, on a brown leather strap, engraved with a cormorant holding a fish in its beak \u2014 the private coat of arms of the Scherb family of Basel, per Jaeger-LeCoultre\u2019s own heritage volume, in a chapter titled \u201cHeraldry for Beginners.\u201d The book explains the charge directly: the cormorant with a fish alludes to the family\u2019s ancestral livelihood as fishermen on the Rhine. The same page illustrates the arms of the Vall\u00e9e de Joux itself \u2014 combining a bear, a monk, and crossed weapons and keys, emblems typical of the municipalities in JLC\u2019s own home valley \u2014 as a point of comparison between a civic coat of arms and a genuine private family one like the Scherbs\u2019.',
      src:'Jaeger-LeCoultre heritage publication, \u201cHeraldry for Beginners,\u201d p.72' },
